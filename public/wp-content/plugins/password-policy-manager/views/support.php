...
echo'	
		<div class = "moppm_mo_page_divided_layout_2">
			...
			<h1>'.__('Support','password-policy-manager').'</h1>
			<p>'.__('Need any help? We are available any time, Just send us a query so we can help you.','password-policy-manager').'</p>
				<form name="f" method="post" action="">
					...
					<table class="moppm_mo_settings_table">
						...
						<tr><td>
							<input type="tel" class="moppm_table_textbox" name="query_phone" id="query_phone" value="'.esc_html($phone).'" placeholder="Enter your phone"/>
							</td>
						</tr>
						<tr>
							<td>
					...
					<input type="submit" name="send_query" id="send_query" value="'.__('Submit Query','password-policy-manager').'" style="margin-bottom:3%;" class="button button-primary"/>
				</form>
				<br/>			
		</div>';
