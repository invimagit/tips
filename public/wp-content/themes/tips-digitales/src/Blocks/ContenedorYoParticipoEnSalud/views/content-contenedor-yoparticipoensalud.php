            ...
            ?>
                  <div class="col-md-12 px-2 pb-4">
                    <div class="slickItem sliders-yoparticipo">
                      <div class="row">
                        <div class="col-md-12">
                          <a href="#" data-bs-toggle="modal" data-bs-target="#modal-yoparticipo-<?php echo $myPost; ?>">
        ...
        <div class="modales">
          <?php
            if($myPosts):
              foreach ($myPosts as $myPost):
          ?>
                <div class="modal modal-yoparticipo" id="modal-yoparticipo-<?php echo $myPost; ?>" aria-labelledby="modal-yoparticipo-<?php echo $myPost; ?>Label" tabindex="-1">
                  <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                      ...
                      <div class="modal-footer py-1">
                        <div class="px-4 texto-descriptivo-modal-yoparticipo">
                          <?php
